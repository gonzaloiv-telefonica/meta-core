    ...
    public static class BuildScript
    {
        ...
        public static void Build()
        {
            ...
            switch (buildTarget)
            {
                ...
                {
                    // "Force to il2cpp & 64b in android"
        ...
        private static Dictionary<string, string> GetValidatedOptions()
        {
            ...
            //Add custom tags for Telefonica projects purposes
            if (validatedOptions.TryGetValue("DEV", out string _))
            {
            ...
            if (validatedOptions.TryGetValue("PRE", out string _))
            {
                string definesString = PlayerSettings.GetScriptingDefineSymbolsForGroup ( EditorUserBuildSettings.selectedBuildTargetGroup );
                definesString += ";PRE";
                PlayerSettings.SetScriptingDefineSymbolsForGroup(EditorUserBuildSettings.selectedBuildTargetGroup, definesString);
            ...
            if (validatedOptions.TryGetValue("MAIN", out string _))
            {
                string definesString = PlayerSettings.GetScriptingDefineSymbolsForGroup ( EditorUserBuildSettings.selectedBuildTargetGroup );
                definesString += ";MAIN";
                PlayerSettings.SetScriptingDefineSymbolsForGroup(EditorUserBuildSettings.selectedBuildTargetGroup, definesString);
